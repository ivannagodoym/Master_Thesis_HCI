...
test22_responses = pd.DataFrame(columns=['conv_id', 'Test2.2_response_GPT35'])
...
#test22_responses.to_csv('test22_responses_GPT35.csv', index=False)
test22_responses.to_csv('test22_responses_GPT35_2.csv', index=False)
