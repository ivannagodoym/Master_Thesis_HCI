...
thesis_df = pd.read_csv(f"{data_path}/thesis_data.csv", sep=",",on_bad_lines='skip')
#thesis_df_sorted = thesis_df.sort_values(by='conv_id')
#print(thesis_df_sorted.head())
...
test_emotions_sample = emotions_list[:5]
